...
namespace Mango.Reporting
{
    public class ReportHelper
    {
        ...
        public static void Report(ReportFormat formats, List<string>[] sections, params string[]? outputFiles)
        {
            ...
            int requiredFiles = CountSetBits((int)formats) - (formats.HasFlag(ReportFormat.SCR) ? 1 : 0);
        ...
        public static List<string> SectionBreak
        {
            get { return new List<string> { _sectionBreak }; }
        }
        /// <summary>
        ...
        private static string ConvertToRTF(List<string> raw)
        {
            ...
            foreach (var lx in raw)
            {
                ...
                string formattedLine = ReplaceColorTagsWithRTF(line, colorMap);
        ...
        private static Dictionary<string, string> BuildRTFColorTable(List<string> lines)
        {
            ...
            int colorIndex = 1; // RTF color table starts at index 1
