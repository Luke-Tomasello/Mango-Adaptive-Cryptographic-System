...
Mango.exe -RunCommand "run munge(--no-cutlist --remove-inverse)" -ExitJobComplete -maxSequenceLen %SEQ_LEN% -inputType UserData -passCount 6 -quiet -mode Cryptographic %FAILDB_FLAG%
