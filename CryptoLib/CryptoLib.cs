...
{
        { 1, new TransformInfo { Name = "XORTx", Id = 1, InverseId = 1, Implementation = XORTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 2, new TransformInfo { Name = "BitRandFlipTx", Id = 2, InverseId = 2, Implementation = BitRandFlipTx, Validator = _ => true, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 3, new TransformInfo { Name = "PassthroughTx", Id = 3, InverseId = 3, Implementation = PassthroughTx, Validator = _ => true, Effect = balance => balance, ExcludeFromPermutations = true, BenchmarkTimeMs = 0.0 } },
        { 4, new TransformInfo { Name = "ShuffleBitsFwdTx", Id = 4, InverseId = 5, Implementation = ShuffleBitsFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 5, new TransformInfo { Name = "ShuffleBitsInvTx", Id = 5, InverseId = 4, Implementation = ShuffleBitsInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 6, new TransformInfo { Name = "MaskedDoubleSubFwdTx", Id = 6, InverseId = 7, Implementation = MaskedDoubleSubFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 7, new TransformInfo { Name = "MaskedDoubleSubInvTx", Id = 7, InverseId = 6, Implementation = MaskedDoubleSubInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 8, new TransformInfo { Name = "ButterflyTx", Id = 8, InverseId = 8, Implementation = ButterflyTx, Validator = _ => true, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 9, new TransformInfo { Name = "SubBytesXorMaskFwdTx", Id = 9, InverseId = 10, Implementation = SubBytesXorMaskFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 10, new TransformInfo { Name = "SubBytesXorMaskInvTx", Id = 10, InverseId = 9, Implementation = SubBytesXorMaskInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 11, new TransformInfo { Name = "SubBytesFwdTx", Id = 11, InverseId = 12, Implementation = SubBytesFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 12, new TransformInfo { Name = "SubBytesInvTx", Id = 12, InverseId = 11, Implementation = SubBytesInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 13, new TransformInfo { Name = "NibbleSwapShuffleFwdTx", Id = 13, InverseId = 14, Implementation = NibbleSwapShuffleFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 14, new TransformInfo { Name = "NibbleSwapShuffleInvTx", Id = 14, InverseId = 13, Implementation = NibbleSwapShuffleInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 15, new TransformInfo { Name = "ApplyMaskBasedMixingTx", Id = 15, InverseId = 15, Implementation = ApplyMaskBasedMixingTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 16, new TransformInfo { Name = "MaskBasedSBoxFwdTx", Id = 16, InverseId = 17, Implementation = MaskBasedSBoxFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 17, new TransformInfo { Name = "MaskBasedSBoxInvTx", Id = 17, InverseId = 16, Implementation = MaskBasedSBoxInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 18, new TransformInfo { Name = "ShuffleNibblesFwdTx", Id = 18, InverseId = 19, Implementation = ShuffleNibblesFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 19, new TransformInfo { Name = "ShuffleNibblesInvTx", Id = 19, InverseId = 18, Implementation = ShuffleNibblesInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 20, new TransformInfo { Name = "ShuffleBytesFwdTx", Id = 20, InverseId = 21, Implementation = ShuffleBytesFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 21, new TransformInfo { Name = "ShuffleBytesInvTx", Id = 21, InverseId = 20, Implementation = ShuffleBytesInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 22, new TransformInfo { Name = "BitFlipCascadeTx", Id = 22, InverseId = 22, Implementation = BitFlipCascadeTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 23, new TransformInfo { Name = "SlidingMaskOverlayTx", Id = 23, InverseId = 23, Implementation = SlidingMaskOverlayTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 24, new TransformInfo { Name = "FrequencyEqualizerFwdTx", Id = 24, InverseId = 25, Implementation = FrequencyEqualizerFwdTx, Validator = _ => true, Effect = balance => balance + 1, BenchmarkTimeMs = 0.0 } },
        { 25, new TransformInfo { Name = "FrequencyEqualizerInvTx", Id = 25, InverseId = 24, Implementation = FrequencyEqualizerInvTx, Validator = balance => balance > 0, Effect = balance => balance - 1, BenchmarkTimeMs = 0.0 } },
        { 26, new TransformInfo { Name = "MicroBlockShufflerFwdTx", Id = 26, InverseId = 27, Implementation = MicroBlockShufflerFwdTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 27, new TransformInfo { Name = "MicroBlockShufflerInvTx", Id = 27, InverseId = 26, Implementation = MicroBlockShufflerInvTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 28, new TransformInfo { Name = "PatternEqualizerTx", Id = 28, InverseId = 28, Implementation = PatternEqualizerTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 29, new TransformInfo { Name = "ButterflyWithPairsFwdTx", Id = 29, InverseId = 30, Implementation = ButterflyWithPairsFwdTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 30, new TransformInfo { Name = "ButterflyWithPairsInvTx", Id = 30, InverseId = 29, Implementation = ButterflyWithPairsInvTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 31, new TransformInfo { Name = "ButterflyWithRotationFwdTx", Id = 31, InverseId = 32, Implementation = ButterflyWithRotationFwdTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 32, new TransformInfo { Name = "ButterflyWithRotationInvTx", Id = 32, InverseId = 31, Implementation = ButterflyWithRotationInvTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 33, new TransformInfo { Name = "BitFlipButterflyFwdTx", Id = 33, InverseId = 34, Implementation = BitFlipButterflyFwdTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 34, new TransformInfo { Name = "BitFlipButterflyInvTx", Id = 34, InverseId = 33, Implementation = BitFlipButterflyInvTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 35, new TransformInfo { Name = "MaskedCascadeSubFwdFbTx", Id = 35, InverseId = 36, Implementation = MaskedCascadeSubFwdFbTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 36, new TransformInfo { Name = "MaskedCascadeSubInvFbTx", Id = 36, InverseId = 35, Implementation = MaskedCascadeSubInvFbTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 37, new TransformInfo { Name = "MicroBlockSwapFwdTx", Id = 37, InverseId = 38, Implementation = MicroBlockSwapFwdTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 38, new TransformInfo { Name = "MicroBlockSwapInvTx", Id = 38, InverseId = 37, Implementation = MicroBlockSwapInvTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } },
        { 39, new TransformInfo { Name = "NibbleInterleaverTx", Id = 39, InverseId = 39, Implementation = NibbleInterleaverTx, Validator = count => count % 2 == 0, Effect = balance => balance  , BenchmarkTimeMs = 0.0 } },
        { 40, new TransformInfo { Name = "ChunkedFbTx", Id = 40, InverseId = 40, Implementation = ChunkedFbTx, Validator = count => count % 2 == 0, Effect = balance => balance, BenchmarkTimeMs = 0.0 } }
};
